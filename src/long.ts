...
async function openLong() {
  ...
  if (args.length < 2) {
    ...
    console.log('Usage: npm run long <symbol> <usdt_amount> [leverage]');
    console.log('\nExamples:');
    console.log('  npm run long BTC 100        # Long $100 worth of BTC at default leverage');
    console.log('  npm run long ETH 50 20      # Long $50 worth of ETH at 20x leverage');
  ...
  console.log(`\n📈 Opening LONG position on ${symbol}`);
